...
import utilities.EmailAttachmentsSender;
...
public class EmailSendUtils {
	...
	public static void sendEmail(int count_totalTCs, int count_passedTCs, int count_failedTCs, int count_skippedTCs) {
				 ...
				 */
				 ...
				 String attachmentFile_ExtentReport = "/test-output/index.html";
				 String PROJECT_PATH = System.getProperty("user.dir");
				 
				 String baseFolderPath = System.getProperty("basefolder.name");
				 
				 String baseFolderPaths = System.getProperty("extent.reporter.pdf.out");
